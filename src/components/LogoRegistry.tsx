      ...
      >
        <div className="upload-shell">
          ...
          <div className="upload-content">
            ...
            <ul>
              <li>
                请上传学校 Logo 的图形标志部分，优先提交校徽、校标或独立图形标识。请不要上传包含学校全称、简称、中英文校名、口号、院系名称或其他文字的组合版 Logo，例如「圆形校徽 + 右侧校名文字」「校徽 + 下方中英文校名」等形式。如学校标识本身确实以文字为核心，或图形部分单独使用会导致无法识别、含义缺失，请在备注中说明原因，并上传最接近官方规范的版本。
              </li>
